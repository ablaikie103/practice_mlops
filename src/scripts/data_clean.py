...
def clean_diabetes_dataset(config):
    ...
    y = df['target']
    X_train, X_test, y_train, y_test = train_test_split(X, y, test_size=config['data_clean']['test_size'], random_state=config['base']['random_state'])
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Clean diabetes dataset and split into test and control groups')
